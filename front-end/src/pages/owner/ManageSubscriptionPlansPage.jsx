...
import { FaBan, FaCheck, FaEdit, FaPlus, FaTimes, FaTrash } from "react-icons/fa";
      ...
      <header className="flex flex-col md:flex-row justify-between items-center mb-8 bg-white/70 backdrop-blur-sm p-6 rounded-large shadow-custom transition-all duration-500 hover:shadow-xl">
        <div className="text-center md:text-left mb-4 md:mb-0">
          ...
          <p className="text-text-muted">
            Create, edit, and manage subscription plans from the owner panel.
          </p>
        </div>
        <button
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-5">
              ...
              <div className="flex gap-3 pt-2">
                <button
                  type="button"
                  onClick={() => setShowModal(false)}
                  className="flex-1 py-2.5 rounded-full border border-gray-300 text-gray-600 font-semibold hover:bg-gray-50 transition-all"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  disabled={submitting}
                  className="flex-1 py-2.5 rounded-full bg-primary text-white font-semibold shadow-md hover:brightness-110 transition-all disabled:opacity-60"
                >
                  {submitting
                    ? "Saving..."
                    : editingPlan
